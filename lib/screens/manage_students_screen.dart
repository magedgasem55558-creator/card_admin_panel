...
class _ManageStudentsScreenState extends State<ManageStudentsScreen> {
  ...
  Future<void> _editStudent(Student student) async {
    ...
    final pointsCtrl = TextEditingController(text: student.totalPoints.toString());
                    ...
                    : ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return ListTile(
                            ...
                            subtitle: Text(
                              'الحلقة: ${student.halaqaName ?? "غير محددة"} | النقاط: ${student.totalPoints} | ${student.isActive ? "نشط" : "غير نشط"}',
                            ),
                            trailing: Row(
                              mainAxisSize: MainAxisSize.min,
                              children: [
